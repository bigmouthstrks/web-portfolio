...
const TO_EMAIL = 'ben@bencaceres.com';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    await resend.emails.send({
      // Change this to a verified domain address once you add bencaceres.com in Resend.
      // While testing, "onboarding@resend.dev" works for the first verified address.
