...
function initContactForm() {
    ...
    submitBtn.addEventListener('click', (e) => {
        ...
        // Simulate sending
        setTimeout(() => {
            submitBtn.innerHTML = '<span class="btn-text">MENSAJE ENVIADO</span><span class="btn-icon">✓</span>';
...
function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.section-title, .about-card, .project-card, .skills-hud, .contact-container');
...
function randomGlitch() {
    const elements = document.querySelectorAll('.section-title, .brand-text');
...
function initLanguageSystem() {
    ...
    const languageContent = {
        es: {
            ...
            homeDescription: 'Desarrollador iOS especializado con 4+ años de experiencia construyendo aplicaciones escalables en banca, fintech y consultoría. Experto en Swift, UIKit y arquitecturas modernas (VIPER, MVVM, MVC).',
            ...
            profileDescription: 'iOS Software Engineer con 4+ años de experiencia construyendo aplicaciones escalables en banca, fintech y consultoría. Especializado en Swift, UIKit y arquitecturas modernas como VIPER, MVVM y MVC. Experto en liderar equipos, mentoring y entregar funcionalidades de alto impacto en entornos Agile.',
            ...
            // Skills section
            skillsTitle: 'HABILIDADES Y EXPERTISE',
        ...
        en: {
            ...
            homeTitle: 'BENJAMÍN CÁCERES',
            homeSubtitle: 'iOS Software Engineer',
            homeDescription: 'iOS developer specialized with 4+ years of experience building scalable apps in banking, fintech, and consulting. Expert in Swift, UIKit, and modern architectures (VIPER, MVVM, MVC).',
            ...
            profileDescription: 'iOS Software Engineer with 4+ years of experience building scalable applications in banking, fintech, and consulting. Specialized in Swift, UIKit, and modern architectures like VIPER, MVVM, and MVC. Expert in leading teams, mentoring, and delivering high-impact features in Agile environments.',
    ...
    function updateSpecificContent(lang) {
        ...
        document.querySelectorAll('.nav-link').forEach((link, index) => {
            const keys = ['home', 'about', 'experience', 'skills', 'education', 'contact'];
        ...
        if (homeSubtitle && content.homeSubtitle) {
            homeSubtitle.textContent = content.homeSubtitle;
        }

        const homeDescription = document.querySelector('.home-description');
        if (homeDescription && content.homeDescription) {
            homeDescription.textContent = content.homeDescription;
        }
        ...
        statLabels.forEach((label, index) => {
            if (content[statKeys[index]]) {
                label.textContent = content[statKeys[index]];
            }
        });

        // Update button texts
        const viewExperienceBtn = document.querySelector('[data-target="experience"] .btn-text');
        if (viewExperienceBtn && content.viewExperience) {
            viewExperienceBtn.textContent = content.viewExperience;
        }

        const contactBtn = document.querySelector('[data-target="contact"] .btn-text');
        if (contactBtn && content.contact) {
            contactBtn.textContent = content.contact;
        }

        // Update section titles
        const sectionTitles = document.querySelectorAll('.section-title');
        const titleKeys = ['aboutTitle', 'experienceTitle', 'skillsTitle', 'educationTitle', 'contactTitle'];
        sectionTitles.forEach((title, index) => {
            if (content[titleKeys[index]]) {
                title.textContent = content[titleKeys[index]];
            }
        });
...
function initContentLoader() {
    ...
    function updateContent(language) {
        ...
        // Update navigation
        const navLinks = document.querySelectorAll('.nav-link');
        const navKeys = ['home', 'about', 'experience', 'skills', 'education', 'contact'];
        ...
        // Update section titles
        const sectionTitles = document.querySelectorAll('.section-title');
        const titleKeys = ['about', 'experience', 'skills', 'education', 'contact'];
        sectionTitles.forEach((title, index) => {
            if (content[titleKeys[index]] && content[titleKeys[index]].title) {
                title.textContent = content[titleKeys[index]].title;
            }
        });
